package latte.lib.kv.redis.impl.jedis2x;



import static latte.lib.kv.redis.impl.jedis2x.CommandCallbackType.commandCallbackTable;

import java.nio.charset.StandardCharsets;
import java.util.function.Function;
import latte.lib.kv.redis.impl.AbstractExecKVClient;
import latte.lib.redis.RedisType;
import latte.lib.redis.api.CommonCommand.ActionType;
...
public  class  DefaultJedisClient extends AbstractExecKVClient {
  JedisPool jedisPool;
  String host;
  int port;
  public DefaultJedisClient(String host, int port, int timeout, int maxTotal, int maxIdle) {
    this.host = host;
    this.port = port;
